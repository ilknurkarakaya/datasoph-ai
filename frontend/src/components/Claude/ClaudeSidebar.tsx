...
import { useDarkMode, useUser, useChat, useSidebar } from '../../App';
            ...
            if (firstUserMessage) {
              ...
              setChatHistory(prev => {
                ...
                if (existingIndex >= 0) {
                  ...
                  newHistory = [...prev];
                  newHistory[existingIndex] = { id: sessionId, title, messages };
                } else {
                  // Create new session
                  newHistory = [{ id: sessionId, title, messages }, ...prev.slice(0, 9)];
                }
